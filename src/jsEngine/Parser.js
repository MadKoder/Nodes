var parser = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c61 = function(typeAndId, templates, params, body) {
        		var func = {
        			id : typeAndId.id, 
        			in: params, 
        			out : {
        ...
        peg$c62 = function(val) {return {nodes : [], val : val};},
        peg$c63 = function(nodes) {return nodes;},
        peg$c64 = function(nodes, val) {return {nodes : nodes ? nodes : [], val : val};},
        peg$c65 = function(type, id) { return {type:type, id:id};},
        peg$c66 = function(id) {return {type:null, id:id};},
        peg$c67 = function(type) {return type},
        peg$c68 = function(base, templates) {
        		if(templates != null)
        		{
        			return {
        				base : base,
        ...
        peg$c70 = function(fields) {return fields;},
        peg$c71 = "groups",
        peg$c72 = { type: "literal", value: "groups", description: "\"groups\"" },
        peg$c73 = "leaves",
        peg$c74 = { type: "literal", value: "leaves", description: "\"leaves\"" },
        peg$c75 = function(id, fields, groups, leaves) {
        		var ret = {
        			name : id,
        			groups : groups,
        			leaves : leaves
        ...
        peg$c76 = function(fieldsAndSubs) {return fieldsAndSubs;},
        peg$c77 = function(id, fieldsAndSubs) {
        		var ret = {
        			name : id
        		}
        ...
        peg$c78 = "subs",
        peg$c79 = { type: "literal", value: "subs", description: "\"subs\"" },
        peg$c80 = function(structs) {return structs;},
        peg$c81 = function(fields, subs) {
        		return {
        			fields : fields,
        			subs : subs != null ? subs : []};
        	},
        peg$c82 = function(field) {return field},
        ...
        peg$c84 = void 0,
        peg$c85 = function(idList, type) {
        		return idList.map(function(id){
        			return [id, type];
        		});
        	},
        peg$c86 = "slot ",
        peg$c87 = { type: "literal", value: "slot ", description: "\"slot \"" },
        peg$c88 = function(params) {return params;},
        peg$c89 = function(id, params, action) {
        		var slot = {
        			slot : id,
        			action : action,
        			params : []
        ...
        peg$c91 = "select ",
        peg$c92 = { type: "literal", value: "select ", description: "\"select \"" },
        peg$c93 = "along ",
        peg$c94 = { type: "literal", value: "along ", description: "\"along \"" },
        peg$c95 = function(path) {return path;},
        peg$c96 = function(id, path, matches) {
        		var ret = {
        			select : id,
        			matches : matches
        		};
        ...
        peg$c97 = function(s) {return s},
        peg$c98 = function(selector, val) {
        		var ret = {
        			selector : selector,
        			val : val
        		};
        ...
        peg$c115 = "for ",
        peg$c116 = { type: "literal", value: "for ", description: "\"for \"" },
        peg$c117 = "when ",
        peg$c118 = { type: "literal", value: "when ", description: "\"when \"" },
        peg$c119 = function(test) {return test},
        peg$c120 = function(val, it, when) {
        		var res = {
        			"comp" : val,
        			"it" : it
        		};
        ...
        peg$c121 = function(i) {return i;},
        peg$c122 = "in ",
        peg$c123 = { type: "literal", value: "in ", description: "\"in \"" },
        peg$c124 = function(it, index, array) {
        		var res = {
        			"for" : it,
        			"in" : array,
        		}
        ...
        peg$c125 = function(ids) {
        		return {
        			destruct : ids
        		};
        	},
        peg$c126 = { type: "other", description: "Actions" },
        peg$c127 = { type: "other", description: "Action" },
        peg$c128 = function(actions) {return  {
        			type : "Seq",
        			slots : actions
        		};},
        peg$c129 = "while",
        ...
        peg$c131 = "do ",
        peg$c132 = { type: "literal", value: "do ", description: "\"do \"" },
        peg$c133 = function(param, action) {
        		return {
        			while:param, 
        			do:action};
        	},
        peg$c134 = function(id, val) { 
        		var action = {signal : id};
        ...
        peg$c139 = "do",
        peg$c140 = { type: "literal", value: "do", description: "\"do\"" },
        peg$c141 = function(it, index, array, action) {
        		var res =  {
        			"for" : it,
        			"in" : array,
        			"do" : action
        ...
        peg$c142 = "type",
        peg$c143 = { type: "literal", value: "type", description: "\"type\"" },
        peg$c144 = "apply",
        peg$c145 = { type: "literal", value: "apply", description: "\"apply\"" },
        peg$c146 = function(id, matchCases) {
        		return {
        			matchType : id,
        			with : matchCases
        		};
        	},
        peg$c147 = function(type, action) {
        		return {
        			type : type,
        			action : action
        		}
        ...
        peg$c148 = "update",
        peg$c149 = { type: "literal", value: "update", description: "\"update\"" },
        peg$c150 = "with ",
        peg$c151 = { type: "literal", value: "with ", description: "\"with \"" },
        peg$c152 = "filter ",
        peg$c153 = { type: "literal", value: "filter ", description: "\"filter \"" },
        peg$c154 = function(it, index, array, val, filter) {
        		var res = {
        			"update" : it,
        			"in" : array			
        		}
        ...
        peg$c155 = function(cond) {return {cond : cond};},
        peg$c156 = function(val) {return {val : val};},
        peg$c157 = "if ",
        peg$c158 = { type: "literal", value: "if ", description: "\"if \"" },
        peg$c159 = function(val, cond) {
        		return {
        			"val" : val,
        			"if" : cond
        		};
        ...
        peg$c160 = "select",
        peg$c161 = { type: "literal", value: "select", description: "\"select\"" },
        peg$c162 = function(it, actions) {
        		var res =  {
        			"select" : it,
        			"apply" : actions
        		};
        ...
        peg$c163 = function(selector, val) {
        		var ret = {
        			selector : selector,
        			affectations : val
        		};
        ...
        peg$c164 = "foreach ",
        peg$c165 = { type: "literal", value: "foreach ", description: "\"foreach \"" },
        peg$c166 = function(id, signal, params) {
        		return {
        			foreach : id,
        			signal : signal,
        ...
        peg$c167 = function(id, path, params) {
        ...
        peg$c168 = function(start, subPath) {
        		var finalPath = [start];
        		if(subPath != null)
        ...
        peg$c169 = "if",
        peg$c170 = { type: "literal", value: "if", description: "\"if\"" },
        peg$c171 = "then",
        peg$c172 = { type: "literal", value: "then", description: "\"then\"" },
        peg$c173 = "else",
        peg$c174 = { type: "literal", value: "else", description: "\"else\"" },
        peg$c175 = function(action) {return action;},
        peg$c176 = function(param, action, elseAction) {
        		var graph =
        		{
        			if:param, 
        			then:action
        ...
        peg$c177 = { type: "other", description: "params" },
        peg$c178 = function(slot, val) {return {
                    "param": val,
                    "slots": [slot],
                    "type": "Send"
                };},
        peg$c179 = function(fields) {return {fields : fields};},
        peg$c180 = function(expr) {return {params : expr};},
        peg$c181 = function(fields, expr) {return {params : expr, fields : fields};},
        peg$c182 = function(headExpr, tailExpr) {return [headExpr].concat(tailExpr);},
        peg$c183 = function(f) {return f},
        ...
        peg$c185 = function(id, val) {return [id, val];},
        peg$c186 = "true",
        ...
        peg$c194 = function() { return {array : []};},
        peg$c195 = function(expression) { return expression; },
        peg$c196 = function(item) {return item[0];},
        peg$c197 = function(array) { return [array[2].concat(array[3])]; },
        peg$c198 = function(v) { return v;},
        peg$c199 = function(id, typeParams, calls) {	
        		var ret = id;
        ...
        peg$c214 = function(id, affectations) {
        		return {
        			merge : id,
        			with : affectations
        		};
        	},
        peg$c215 = function(affectation) {return affectation},
        peg$c216 = function(cond, affectations, elseAffectations) {
        		var aff = {
        			"cond" : cond,
        ...
        peg$c217 = function(aff) {return aff;},
        peg$c218 = function(paths, val) {
        		return {
        			paths : paths,
        			val : val
        		};
        ...
        peg$c219 = "match ",
        peg$c220 = { type: "literal", value: "match ", description: "\"match \"" },
        peg$c221 = function(what, cases, elseCase) {
        		return {
        			match : what,
        			cases : cases,
        			else : elseCase
        ...
        peg$c225 = function(out) {
        		return out;
        	},
        peg$c226 = function(type, val) {
        		return {
        			type : type,
        			val : val
        		}
        ...
        peg$c227 = "let",
        peg$c228 = { type: "literal", value: "let", description: "\"let\"" },
        peg$c229 = function(what, val) {
        	return {
        		let : what,
        		in : val
        	}
        ...
        peg$c240 = function(path, subPath) {
        		var finalPath = [path];
        		if(subPath != null)
        			finalPath = finalPath.concat(subPath);
        		return finalPath;
        	},
        peg$c241 = function(index, subPath) {
        ...
        peg$c245 = function(operator, expression) {
              return {
        ...
        peg$c255 = function(operator) { return operator; },
        ...
        peg$c296 = function(literal) {
              return literal;
            },
        peg$c297 = function(parts) {
              return parseFloat(parts.join(""));    },
        peg$c298 = function(parts) { return parseFloat(parts.join("")); },
        peg$c299 = function(int) {return parseInt(int);},
        peg$c300 = "0",
        peg$c301 = { type: "literal", value: "0", description: "\"0\"" },
        peg$c302 = function(parts) {return parts.join("");},
        peg$c303 = function(d) {return d.join("");},
        peg$c304 = /^[0-9]/,
        peg$c305 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c306 = /^[1-9]/,
        peg$c307 = { type: "class", value: "[1-9]", description: "[1-9]" },
        peg$c308 = /^[eE]/,
        peg$c309 = { type: "class", value: "[eE]", description: "[eE]" },
        peg$c310 = /^[\-+]/,
        peg$c311 = { type: "class", value: "[\\-+]", description: "[\\-+]" },
        peg$c312 = /^[xX]/,
        peg$c313 = { type: "class", value: "[xX]", description: "[xX]" },
        peg$c314 = function(digits) { return parseInt("0x" + digits); },
        peg$c315 = /^[0-9a-fA-F]/,
        peg$c316 = { type: "class", value: "[0-9a-fA-F]", description: "[0-9a-fA-F]" },
        peg$c317 = "$",
        peg$c318 = { type: "literal", value: "$", description: "\"$\"" },
        peg$c319 = { type: "other", description: "whitespace" },
        peg$c320 = /^[\t\x0B\f \xA0\uFEFF]/,
        peg$c321 = { type: "class", value: "[\\t\\x0B\\f \\xA0\\uFEFF]", description: "[\\t\\x0B\\f \\xA0\\uFEFF]" },
        peg$c322 = /^[ \xA0\u1680\u180E\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000]/,
        peg$c323 = { type: "class", value: "[ \\xA0\\u1680\\u180E\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200A\\u202F\\u205F\\u3000]", description: "[ \\xA0\\u1680\\u180E\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200A\\u202F\\u205F\\u3000]" },
        peg$c324 = { type: "other", description: "end of line" },
        peg$c325 = "\n",
        peg$c326 = { type: "literal", value: "\n", description: "\"\\n\"" },
        peg$c327 = "\r\n",
        peg$c328 = { type: "literal", value: "\r\n", description: "\"\\r\\n\"" },
        peg$c329 = "\r",
        peg$c330 = { type: "literal", value: "\r", description: "\"\\r\"" },
        peg$c331 = "\u2028",
