parser = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c139 = "apply",
        peg$c140 = { type: "literal", value: "apply", description: "\"apply\"" },
        ...
        peg$c144 = function(id, matchCases) {
        		return {
        			matchType : id,
        			with : matchCases
        		};
        	},
        peg$c145 = function(type, action) {
        		return {
        			type : type,
        			action : action
        		}
        ...
        peg$c146 = "update",
        peg$c147 = { type: "literal", value: "update", description: "\"update\"" },
        peg$c148 = "with ",
        peg$c149 = { type: "literal", value: "with ", description: "\"with \"" },
        peg$c150 = "filter ",
        peg$c151 = { type: "literal", value: "filter ", description: "\"filter \"" },
        peg$c152 = function(it, index, array, val, filter) {
        		var res = {
        			"update" : it,
        			"in" : array			
        		}
        ...
        peg$c153 = function(cond) {return {cond : cond};},
        peg$c154 = function(val) {return {val : val};},
        peg$c155 = "if ",
        peg$c156 = { type: "literal", value: "if ", description: "\"if \"" },
        peg$c157 = function(val, cond) {
        		return {
        			"val" : val,
        			"if" : cond
        		};
        ...
        peg$c158 = "select",
        peg$c159 = { type: "literal", value: "select", description: "\"select\"" },
        peg$c160 = function(it, actions) {
        		var res =  {
        			"select" : it,
        			"apply" : actions
        		};
        ...
        peg$c161 = function(selector, val) {
        		var ret = {
        			selector : selector,
        			affectations : val
        		};
        ...
        peg$c162 = "foreach ",
        peg$c163 = { type: "literal", value: "foreach ", description: "\"foreach \"" },
        peg$c164 = function(id, signal, params) {
        		return {
        			foreach : id,
        			signal : signal,
        ...
        peg$c165 = function(id, path, params) {
        ...
        peg$c166 = function(start, subPath) {
        		var finalPath = [start];
        		if(subPath != null)
        ...
        peg$c167 = "if",
        peg$c168 = { type: "literal", value: "if", description: "\"if\"" },
        peg$c169 = "then",
        peg$c170 = { type: "literal", value: "then", description: "\"then\"" },
        peg$c171 = "else",
        peg$c172 = { type: "literal", value: "else", description: "\"else\"" },
        peg$c173 = function(action) {return action;},
        peg$c174 = function(param, action, elseAction) {
        		var graph =
        		{
        			if:param, 
        			then:action
        ...
        peg$c175 = { type: "other", description: "params" },
        peg$c176 = function(slot, val) {return {
                    "param": val,
                    "slots": [slot],
                    "type": "Send"
                };},
        peg$c177 = function(fields) {return {fields : fields};},
        peg$c178 = function(expr) {return {params : expr};},
        peg$c179 = function(fields, expr) {return {params : expr, fields : fields};},
        peg$c180 = function(headExpr, tailExpr) {return [headExpr].concat(tailExpr);},
        ...
        peg$c183 = function(id, val) {return [id, val];},
        peg$c184 = "true",
        ...
        peg$c192 = function() { return {array : []};},
        peg$c193 = function(expression) { return expression; },
        peg$c194 = function(item) {return item[0];},
        peg$c195 = function(array) { return [array[2].concat(array[3])]; },
        peg$c196 = function(v) { return v;},
        peg$c197 = function(id, typeParams, calls) {	
        		var ret = id;
        ...
        peg$c198 = function(types) {
        		return types;
        	},
        peg$c199 = function(params) {
        		var ret = {};
        		if(params != null)
        		{
        ...
        peg$c204 = function(text) {
        		return {
        			string : text.join("")};
        	},
        peg$c205 = "then ",
        peg$c206 = { type: "literal", value: "then ", description: "\"then \"" },
        peg$c207 = "else ",
        peg$c208 = { type: "literal", value: "else ", description: "\"else \"" },
        peg$c209 = function(cond, t, e) {
        		return {
                  type:     "if",
                  params : [cond, t, e]
                };
        ...
        peg$c212 = function(id, affectations) {
        		return {
        			merge : id,
        			with : affectations
        		};
        	},
        peg$c213 = function(affectation) {return affectation},
        peg$c214 = function(cond, affectations, elseAffectations) {
        		var aff = {
        			"cond" : cond,
        ...
        peg$c215 = function(aff) {return aff;},
        peg$c216 = function(paths, val) {
        		return {
        			paths : paths,
        			val : val
        		};
        ...
        peg$c217 = "match ",
        peg$c218 = { type: "literal", value: "match ", description: "\"match \"" },
        peg$c219 = function(what, cases, elseCase) {
        		return {
        			match : what,
        			cases : cases,
        			else : elseCase
        ...
        peg$c221 = "_",
        peg$c222 = { type: "literal", value: "_", description: "\"_\"" },
        peg$c223 = function(out) {
        		return out;
        	},
        peg$c224 = function(type, val) {
        		return {
        			type : type,
        			val : val
        		}
        ...
        peg$c225 = "let",
        peg$c226 = { type: "literal", value: "let", description: "\"let\"" },
        peg$c227 = function(what, val) {
        	return {
        		let : what,
        		in : val
        	}
        ...
        peg$c238 = function(path, subPath) {
        		var finalPath = [path];
        		if(subPath != null)
        			finalPath = finalPath.concat(subPath);
        		return finalPath;
        	},
        peg$c239 = function(index, subPath) {
        ...
        peg$c243 = function(operator, expression) {
              return {
        ...
        peg$c253 = function(operator) { return operator; },
        ...
        peg$c293 = { type: "other", description: "number" },
        peg$c294 = function(literal) {
              return literal;
            },
        peg$c295 = function(parts) {
              return parseFloat(parts.join(""));    },
        peg$c296 = function(parts) { return parseFloat(parts.join("")); },
        peg$c297 = function(int) {return parseInt(int);},
        peg$c298 = "0",
        peg$c299 = { type: "literal", value: "0", description: "\"0\"" },
        peg$c300 = function(parts) {return parts.join("");},
        peg$c301 = function(d) {return d.join("");},
        peg$c302 = /^[0-9]/,
        peg$c303 = { type: "class", value: "[0-9]", description: "[0-9]" },
        peg$c304 = /^[1-9]/,
        peg$c305 = { type: "class", value: "[1-9]", description: "[1-9]" },
        peg$c306 = /^[eE]/,
        peg$c307 = { type: "class", value: "[eE]", description: "[eE]" },
        peg$c308 = /^[\-+]/,
        peg$c309 = { type: "class", value: "[\\-+]", description: "[\\-+]" },
        peg$c310 = /^[xX]/,
        peg$c311 = { type: "class", value: "[xX]", description: "[xX]" },
        peg$c312 = function(digits) { return parseInt("0x" + digits); },
        peg$c313 = /^[0-9a-fA-F]/,
        ...
        peg$c318 = /^[\t\x0B\f \xA0\uFEFF]/,
        peg$c319 = { type: "class", value: "[\\t\\x0B\\f \\xA0\\uFEFF]", description: "[\\t\\x0B\\f \\xA0\\uFEFF]" },
        peg$c320 = /^[ \xA0\u1680\u180E\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000]/,
        peg$c321 = { type: "class", value: "[ \\xA0\\u1680\\u180E\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200A\\u202F\\u205F\\u3000]", description: "[ \\xA0\\u1680\\u180E\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200A\\u202F\\u205F\\u3000]" },
        peg$c322 = { type: "other", description: "end of line" },
        peg$c323 = "\n",
